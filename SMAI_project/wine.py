...
if __name__ == "__main__":
	...
	purity = check(gt,index)
	#print("Number of data points in Cluster 0: " + str(index.count(0)))
	#print("Number of data points in Cluster 1: " + str(index.count(1)))
	#print("Number of data points in Cluster 0: " + str(index.count(2)))
	print "purity: ",purity
