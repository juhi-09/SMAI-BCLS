...
if __name__ == "__main__":
    ...
    data,class_labels,k = readCSV("ionosphere.csv")
    #########################################
    # print class_labels
    print("class_labels Number of data points in Cluster 0: " + str(class_labels.count(0)))
    print(" class_labels Number of data points in Cluster 1: " + str(class_labels.count(1)))
